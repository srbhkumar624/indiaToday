...
const url="https://newsdata.io/api/1/news?apikey=pub_8197fcabafb32999a0cccf108a2141410681&country=in&language=en&category=health";
fetch(url)
.then(function(res){
    return res.json();
})
...
let div=document.getElementById("health_news");
