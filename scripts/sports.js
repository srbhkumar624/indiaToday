...
let nav1=document.getElementById("s_navbar");
let nav2=document.getElementById("s_navbar2");
let foot=document.getElementById("footer")
nav1.innerHTML=navbar();
foot.innerHTML=footer();
nav2.innerHTML=navbar2();
const url="https://newsdata.io/api/1/news?apikey=pub_8197fcabafb32999a0cccf108a2141410681&country=in&language=en&category=sports";
fetch(url)
.then(function(res){
    return res.json();
})
...
let div=document.getElementById("sports_news");
