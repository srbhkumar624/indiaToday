...
const url="https://newsdata.io/api/1/news?apikey=pub_8197fcabafb32999a0cccf108a2141410681&category=business&language=en";
fetch(url)
.then(function(res){
    return res.json();
})
...
let div=document.getElementById("business_news");
